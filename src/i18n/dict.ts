...
const ru: typeof en = {
  ...
  home: {
    ...
    stats: {
      ...
      planningValue: "3D",
      planningLabel: "Kratos — предоперационная симуляция",
      patientsValue: "30+",
      patientsLabel: "иностранных пациентов в месяц",
    },
    philosophy: {
      eyebrow: "Философия",
      quoteA: "«Красота — это не совершенство, а",
      quoteAccent1: "гармония",
      quoteB: ", уверенность и ощущение покоя в собственном теле. Эстетическая хирургия — это не превращение, а изящное возвращение к",
      quoteAccent2: "лучшей версии себя",
      quoteC: ".»",
      attribution: "— Доктор Гамзе Эрен",
      side: "Каждая консультация начинается с того, что мы слушаем. Дальше — миллиметровое планирование, трёхмерная симуляция и максимально деликатная техника, которую позволяет результат.",
  ...
  about: {
    eyebrow: "Обо мне",
    headlineA: "Точность — это ремесло.",
    headlineAccent: "Красота — её результат.",
    lede: "Доктор Гюлер Гамзе Эрен — пластический хирург из Стамбула, известная естественными результатами, скрупулёзной техникой и неспешным подходом к консультации. Её практика сочетает глубину хирургии с тихой уверенностью художника.",
    portrait: {
      role: "Доктор",
    ...
    approach: {
      ...
      paragraphs: [
        "Практика доктора Эрен строится на трёх принципах. Первый — гармония: каждое изменение оценивается вместе с остальным лицом или телом, а не изолированно. Второй — сдержанность: делать только то, что нужно для желаемого результата, и ничего больше. Третий — прозрачность: 3D-симуляция, откровенный разговор и письменный план, чтобы вы точно знали, что предлагается.",
  ...
  contact: {
    ...
    headlineB: "разговор.",
    lede: "Поделитесь несколькими деталями, и команда доктора Эрен свяжется с вами в течение одного рабочего дня. Каждое сообщение читает человек, а не бот.",
    form: {
