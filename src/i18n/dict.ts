...
const en = {
  ...
  calculator: {
    ...
    lede: "Select the procedures you are considering. We\'ll calculate a personalised price estimate — the second procedure is discounted 25%, and any further procedures too.",
    title: "Procedure Calculator",
    subtitle: "Estimate your package cost",
    ...
    ctaLabel: "Request your personalised quote",
    disclaimer: "Price ranges are estimates based on hospital tariffs. Final pricing is confirmed after your free online consultation with Dr. Gamze Eren.",
    remove: "Remove",
    fullPrice: "Full price",
    off: "off",
    emptyHint: "Add your first procedure above to see an estimate.",
    ctaBanner: "Curious about the cost?",
    ctaBannerSub: "Build your package and get an instant estimate.",
    ctaBannerLink: "Try the calculator →",
  },
  footer: {
    tagline:
...
const tr: typeof en = {
  ...
  calculator: {
    ...
    lede: "Düşündüğünüz prosedürleri seçin. İkinci prosedürde %25 indirim uygulanır ve diğer eklentilerde de indirim geçerlidir.",
    title: "Prosedür Hesaplayıcı",
    subtitle: "Paket maliyetinizi tahmin edin",
    ...
    ctaLabel: "Kişiselleştirilmiş fiyat teklifi alın",
    disclaimer: "Fiyat aralıkları hastane tarifelerine dayalı tahminlerdir. Kesin fiyat, Dr. Gamze Eren ile ücretsiz online konsültasyon sonrası belirlenir.",
    remove: "Kaldır",
    fullPrice: "Tam fiyat",
    off: "indirim",
    emptyHint: "Tahmin görmek için yukarıdan ilk prosedürü ekleyin.",
    ctaBanner: "Maliyet merak ediyor musunuz?",
    ctaBannerSub: "Paketinizi oluşturun ve anında tahmin alın.",
    ctaBannerLink: "Hesaplayıcıyı deneyin →",
  },
  footer: {
    tagline:
