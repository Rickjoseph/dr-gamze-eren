...
export const bioStimulators: Treatment = {
  ...
  content: {
      ...
      faqs: [
        {
          ...
          a: "Filler adds volume immediately; bio-stimulators prompt your own collagen to rebuild firmness gradually, for a more foundational, natural result over time.",
        },
        {
      ...
      faqs: [
        {
          ...
          a: "Dolgu hacmi hemen ekler; biyo-uyarıcılar kendi kolajeninizi kademeli olarak sıkılığı yeniden inşa etmesi için uyarır; bu da zamanla daha temel, doğal bir sonuç verir.",
        },
        {
    ...
    ru: {
      metaTitle: "Биостимуляторы (стимуляторы коллагена) в Стамбуле — Dr. Gamze Eren",
      metaDescription:
        "Инъекционные стимуляторы коллагена, постепенно восстанавливающие упругость и естественный объём. Доктор Гамзе Эрен, Стамбул.",
      title: "Биостимуляторы (стимуляторы коллагена)",
      tagline: "Постепенное и естественное восстановление упругости изнутри.",
      summary:
        "Биостимуляторы — инъекционные процедуры, которые побуждают кожу вырабатывать собственный коллаген, постепенно восстанавливая упругость, плотность и естественный лифтинг в течение месяцев — результат нарастает деликатно, а не появляется за одну ночь.",
      sections: [
        {
          heading: "Как они работают",
          body: "В отличие от филлеров, которые добавляют объём напрямую, биостимуляторы работают, побуждая кожу заново строить собственный коллаген. За недели и месяцы это постепенно улучшает упругость, плотность и эластичность и смягчает запавшие зоны — естественное, фундаментальное омоложение.\n\nОни подходят коже, начинающей терять упругость и структуру, и хорошо сочетаются с другими процедурами в комплексном плане.",
        },
        {
          heading: "Чего ожидать",
          body: "Препарат вводится по всей зоне, иногда с последующим массажем для равномерного распределения. Сеанс занимает около 20–30 минут, с минимальным простоем — возможны покраснение или отёк, проходящие за день-два.\n\nДля лучшей основы обычно планируется короткий курс сеансов с интервалом в несколько недель.",
        },
        {
          heading: "Результат и стойкость",
          body: "Поскольку эффект исходит от вашего собственного коллагена, результат проявляется постепенно за два-три месяца и продолжает улучшаться. Вид естественный — более упругая, свежая кожа, а не добавленный объём.\n\nРезультат — один из самых длительных среди безоперационных вариантов, часто держится больше года, с периодическим поддержанием.",
        },
      ],
      faqs: [
        {
          q: "Чем это отличается от филлера?",
          a: "Филлер добавляет объём сразу; биостимуляторы побуждают ваш собственный коллаген постепенно восстанавливать упругость, давая более фундаментальный, естественный результат со временем.",
        },
        {
          q: "Когда я увижу результат?",
          a: "Постепенно — за два-три месяца по мере образования нового коллагена, поэтому изменение выглядит так естественно.",
        },
      ],
    },
  },
