export const post = {
  slug: "facelift-facial-rejuvenation-age-gracefully",
  title: "Facelift and Facial Rejuvenation: Aging Gracefully with Subtlety",
  excerpt: "A modern facelift restores youthful contours without erasing character. Dr. Gamze Eren explains how refined technique creates natural-looking results that stand the test of time.",
  date: "2026-05-26",
  category: "Face",
  readTime: "7 min read",
  image: "/img/beauty-profile.jpg",
  imageAlt: "Profile showing refined facial contours in natural light",
  body: `
