export const post = {
  slug: "poland-syndrome-understanding-and-reconstruction",
  title: "Poland Syndrome: Understanding the Condition and Its Reconstruction",
  excerpt:
    "Poland syndrome is a congenital chest difference that's more common, and more treatable, than many realise. Dr. Gamze Eren explains what it is and how reconstruction restores balance.",
  date: "2026-06-06",
  category: "Reconstructive",
  readTime: "7 min read",
  image: "/img/service-breast.jpg",
  imageAlt: "Soft, natural light portrait conveying calm confidence",
  body: `
