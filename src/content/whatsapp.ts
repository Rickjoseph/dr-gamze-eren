...
export const whatsappContent: Record<Locale, WhatsAppStrings> = {
  ...
  de: {
    ...
    tooltip: "Schreiben Sie uns",
    clinicName: "Klinik Dr. Gamze Eren",
    replyTime: "Wir antworten in der Regel innerhalb weniger Stunden",
    intro: "Teilen Sie uns einige Details mit, und wir melden uns bei Ihnen auf WhatsApp.",
    nameLabel: "Ihr Name *",
    namePlaceholder: "z. B. Sophie",
    countryLabel: "Land *",
    countryPlaceholder: "Wählen Sie Ihr Land",
    procedureLabel: "Gewünschter Eingriff *",
    procedurePlaceholder: "Eingriff auswählen",
    messageLabel: "Noch etwas? (optional)",
    messagePlaceholder: "Zeitplanung, Fragen, Anliegen...",
    consentPrefix:
      "Ich stimme zu, über WhatsApp kontaktiert zu werden und dass meine Daten zur Bearbeitung meiner Anfrage verwendet werden, gemäß der ",
    consentPrivacyLink: "Datenschutzerklärung",
    consentAnd: " und den ",
    consentTermsLink: "Allgemeinen Geschäftsbedingungen",
    consentSuffix: ".",
    submit: "Senden & Gespräch starten →",
    submitting: "Wird gesendet…",
    closeAria: "Schließen",
    successTitle: "Vielen Dank!",
    successBody: "Wir haben Ihre Daten erhalten und werden uns in Kürze per WhatsApp bei Ihnen melden.",
    successCta: "WhatsApp jetzt öffnen",
    successClose: "Schließen",
    waPrefill: "Hallo, ich möchte mich nach einer Beratung bei Dr. Gamze Eren erkundigen.",
    procedures: [
      "Rhinoplastik",
      "Brustvergrößerung",
      ...
      "Blepharoplastik (Augenlid)",
      "Browlift",
      "Mommy Makeover",
      "Nicht-chirurgische Behandlung",
      "Sonstiges / Noch nicht sicher",
    ],
    countries: [
      "Vereinigtes Königreich", "Deutschland", "Niederlande", "Frankreich", "Spanien",
      "Ukraine", "Russland", "Polen", "Belgien", "Schweiz",
      "Vereinigte Staaten", "Kanada", "Australien", "Sonstiges",
    ],
  },
};
